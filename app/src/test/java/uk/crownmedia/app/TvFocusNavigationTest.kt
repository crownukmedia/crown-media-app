...
class TvFocusNavigationTest {
    ...
    fun contentLeftAndRightStayInRowWithPredictableBoundaries() {
        assertEquals(TvFocusMove(TvFocusRegion.SIDEBAR), tvContentFocusMove(0, 12, 5, KeyEvent.KEYCODE_DPAD_LEFT, true))
    ...
    fun contentUpAndDownUseLogicalGridRowsIncludingIncompleteLastRow() {
        assertEquals(TvFocusMove(TvFocusRegion.CATEGORIES), tvContentFocusMove(3, 12, 5, KeyEvent.KEYCODE_DPAD_UP, true))
    ...
    @Test
    fun categoriesRemainHorizontalAndOnlyMoveVerticallyToDeclaredRegions() {
        assertEquals(TvFocusMove(TvFocusRegion.CATEGORY_MENU), tvCategoryFocusMove(0, 4, KeyEvent.KEYCODE_DPAD_LEFT, true, true))
        assertEquals(TvFocusMove(TvFocusRegion.ITEM, 2), tvCategoryFocusMove(1, 4, KeyEvent.KEYCODE_DPAD_RIGHT, true, true))
        assertEquals(TvFocusMove(TvFocusRegion.STAY), tvCategoryFocusMove(3, 4, KeyEvent.KEYCODE_DPAD_RIGHT, true, true))
        assertEquals(TvFocusMove(TvFocusRegion.SEARCH), tvCategoryFocusMove(2, 4, KeyEvent.KEYCODE_DPAD_UP, true, true))
        assertEquals(TvFocusMove(TvFocusRegion.CONTENT), tvCategoryFocusMove(2, 4, KeyEvent.KEYCODE_DPAD_DOWN, true, true))
    }
}
