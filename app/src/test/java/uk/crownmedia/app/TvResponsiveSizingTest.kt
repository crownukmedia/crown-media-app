...
class TvResponsiveSizingTest {
    ...
    fun expandedNavigationWidthIsResponsiveAcrossTvResolutionClasses() {
        ...
        assertEquals(204, MainActivity.responsiveTvNavigationWidthDp(640))
        // 1080p and 4K configurations retain a bounded overlay so content never jumps.
        assertEquals(240, MainActivity.responsiveTvNavigationWidthDp(960))
        assertEquals(240, MainActivity.responsiveTvNavigationWidthDp(1280))
    }
